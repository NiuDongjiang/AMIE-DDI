...
class EncoderLayer(keras.layers.Layer):
    ...
    def call(self, x1, x2, training, encoder_padding_mask1,encoder_padding_mask2, adjoin_matrix1,adjoin_matrix2, dist_matrix1,dist_matrix2):
        ...
        x_l1, attention_weights_local1 = self.mha1(x11, x11, x11, encoder_padding_mask1, adjoin_matrix1, dist_matrix=None)
        x_g1, attention_weights_global1 = self.mha2(x12, x12, x12, encoder_padding_mask1, adjoin_matrix=None, dist_matrix=dist_matrix1)
        x_l2, attention_weights_local2 = self.mha1(x21, x21, x21, encoder_padding_mask2, adjoin_matrix2, dist_matrix=None)
        x_g2, attention_weights_global2 = self.mha2(x22, x22, x22, encoder_padding_mask2, adjoin_matrix=None, dist_matrix=dist_matrix2)
